    ...
    <div>
      <div className="max-w-5xl mx-auto px-6 sm:px-8 lg:px-10 py-12 bg-gray-50">
        ...
        <p className="text-base text-gray-700 mb-6">
          ...
          the divorce is confirmed. The reporter gets 2 ETH, and 7 ETH remains in the community pot. If the votes
          against the divorce are higher, the other party receives 1 ETH, the reporter gets nothing, and 9 ETH remains
          in the pot.
        </p>
